...
function taoNew(cwd, args, isVerbose = false) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        return params_1.handleErrors(isVerbose, () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const combinedOpts = yield params_1.combineOptionsForGenerator(opts.generatorOptions, opts.collectionName, normalizedGeneratorName, null, schema, opts.interactive, null);
...
function generate(cwd, root, args, isVerbose = false) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        return params_1.handleErrors(isVerbose, () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const combinedOpts = yield params_1.combineOptionsForGenerator(opts.generatorOptions, opts.collectionName, normalizedGeneratorName, workspaceDefinition, schema, opts.interactive, ws.calculateDefaultProjectName(cwd, workspaceDefinition));
