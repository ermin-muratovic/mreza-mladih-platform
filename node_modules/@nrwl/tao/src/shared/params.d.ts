...
export declare function validateObject(opts: {
    [k: string]: any;
}, properties: Properties, required: string[], definitions: Properties): void;
export declare function setDefaults(opts: {
    [k: string]: any;
}, schema: Schema): {
    [k: string]: any;
};
export declare function combineOptionsForExecutor(commandLineOpts: Options, config: string, target: TargetConfiguration, schema: Schema, defaultProjectName: string | null): any;
export declare function combineOptionsForGenerator(commandLineOpts: Options, collectionName: string, generatorName: string, wc: WorkspaceConfiguration | null, schema: Schema, isInteractive: boolean, defaultProjectName: string | null): Promise<Options>;
export declare function convertSmartDefaultsIntoNamedParams(opts: {
    [k: string]: any;
}, schema: Schema, argv: string[], defaultProjectName: string | null): void;
/**
